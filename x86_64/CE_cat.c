...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 14, 3);
 	...
 	ivoc_help("help ?1 cat /group/neurolab/Neuromorpho_HOC/x86_64/CE_cat.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
    uinf = 1.0 / ( 1.0 + ( exp ( - ( _lv + 59.0 ) / 5.5 ) ) ) ;
   utau = 1.5 + 3.5 / ( ( exp ( - ( _lv + 45.0 ) / 15.0 ) ) + ( exp ( ( _lv + 45.0 ) / 15.0 ) ) ) ;
   zinf = 1.0 / ( 1.0 + ( exp ( ( _lv + 80.0 ) / 4.0 ) ) ) ;
   ztau = 10.0 + 40.0 / ( ( exp ( - ( _lv + 60.0 ) / 15.0 ) ) + ( exp ( ( _lv + 60.0 ) / 15.0 ) ) ) ;
     return 0; }
